...
export default function Page() {
  return (
    <><Navbar/><div className="payment w-full bg-[#f6f7f9] p-4 sm:p-6  flex flex-wrap gap-6 justify-center font-[family-name:var(--font-geist-sans)]">
      <div className="cards w-full md:w-[70%] grid grid-cols-1 gap-6 order-2 lg:order-1">
        <Card className="w-full lg:w-[852px] h-auto lg:h-[336px] flex flex-col justify-around">
          <CardHeader>
            <CardTitle className="text-black">Billing Info</CardTitle>
            <CardDescription className="w-full flex items-center justify-between text-gray-500">
          ...
          <CardContent className="flex flex-col gap-6">
            <div className="w-full flex flex-wrap gap-4">
              <div className="name flex flex-col gap-3 w-full lg:w-[46%]">
                <label className="font-bold text-black" htmlFor="name">Name</label>
              ...
              <div className="num flex flex-col gap-3 w-full lg:w-[50%]">
                <label className="font-bold text-black" htmlFor="num">Phone Number</label>
            ...
            <div className="w-full flex flex-wrap gap-4">
              <div className="add flex flex-col gap-3 w-full lg:w-[46%]">
                <label className="font-bold text-black" htmlFor="add">Address</label>
              ...
              <div className="city flex flex-col gap-3 w-full lg:w-[50%]">
                <label className="font-bold text-black" htmlFor="city">Town/City</label>
        ...
        <Card className="w-full lg:w-[852px] h-auto lg:h-[664px] flex flex-col justify-around">
          <CardHeader>
            <CardTitle className="text-black">Rental Info</CardTitle>
            <CardDescription className="w-full flex items-center justify-between text-gray-500">
          ...
          <CardContent className="flex flex-col gap-6">
            ...
            <div className="sec w-full flex flex-wrap gap-4">
              <div className="add flex flex-col gap-3 w-full lg:w-[46%]">
                <label className="font-bold text-black" htmlFor="add">Locations</label>
                <select title="city" className="bg-[#f6f7f9] px-8 h-[56px] rounded-xl text-gray-500">
                  <option value="">Select Your City</option>
                </select>
              </div>
              <div className="city flex flex-col gap-3 w-full lg:w-[50%]">
                <label className="font-bold text-black" htmlFor="city">Date</label>
                <select title="cty" className="bg-[#f6f7f9] px-8 h-[56px] rounded-xl text-gray-500">
            ...
            <div className="third w-full">
              <div className="city flex flex-col gap-3 w-full lg:w-[45%]">
                <label className="font-bold text-black" htmlFor="city">Time</label>
                <select title="cit" className="bg-[#f6f7f9] px-8 h-[56px] rounded-xl text-gray-500">
        ...
        <Card className="w-full lg:w-[852px] h-auto lg:h-[484px] flex flex-col justify-around">
          <CardHeader>
            <CardTitle className="text-black">Confirmation</CardTitle>
            <CardDescription className="w-full flex items-center justify-between text-gray-500">
